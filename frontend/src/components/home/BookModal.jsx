  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="mt-4">A summary of the book:</p>
        <p className="my-2">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora animi
          doloremque, reiciendis reprehenderit qui doloribus adipisci sunt
          maxime modi, perferendis dolore numquam explicabo quisquam velit
          nesciunt ipsum cumque quae vel?
        </p>
      </div>
    </div>
  );
